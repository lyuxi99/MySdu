 ...
 * 每一项均为PerWeekView
 */
public class MyWeekView extends LinearLayout implements WeekViewEnable<MyWeekView> {
    ...
    private void initView() {
        mInflate.inflate(com.zhuangfei.timetable.R.layout.view_weekview, this);
        container = findViewById(com.zhuangfei.timetable.R.id.id_weekview_container);
        root=findViewById(com.zhuangfei.timetable.R.id.id_root);
    }
    ...
    public MyWeekView showView() {
        ...
        for (int i = 1; i <= itemCount; i++) {
            final int tmp=i;
            View view = mInflate.inflate(com.zhuangfei.timetable.R.layout.item_weekview, null);
            final LinearLayout perLayout=view.findViewById(com.zhuangfei.timetable.R.id.id_perweekview_layout);
            TextView weekText = view.findViewById(com.zhuangfei.timetable.R.id.id_weektext);
            TextView bottomText = view.findViewById(com.zhuangfei.timetable.R.id.id_weektext_bottom);

            weekText.setText("第" + i + "周");
            if(i==curWeek) bottomText.setText("(本周)");
            PerWeekView perWeekView = view.findViewById(com.zhuangfei.timetable.R.id.id_perweekview);
            ...
            perLayout.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    resetBackground();
                    preIndex=tmp;
                    perLayout.setBackgroundDrawable(getContext().getResources().getDrawable(com.zhuangfei.timetable.R.drawable.weekview_white));
        ...
        if(curWeek>0&&curWeek<=layouts.size()){
            layouts.get(curWeek-1).setBackgroundDrawable(getContext().getResources().getDrawable(com.zhuangfei.timetable.R.drawable.weekview_thisweek));
        }
        return this;
    }
    ...
    public MyWeekView updateView(){
        ...
        for(int i=0;i<layouts.size();i++){
            ...
            layouts.get(i).setBackgroundColor(getContext().getResources().getColor(com.zhuangfei.timetable.R.color.app_course_chooseweek_bg));
        }
    ...
    public void resetBackground(){
        layouts.get(preIndex-1).setBackgroundColor(getContext().getResources().getColor(com.zhuangfei.timetable.R.color.app_course_chooseweek_bg));
        layouts.get(curWeek-1).setBackgroundDrawable(getContext().getResources().getDrawable(com.zhuangfei.timetable.R.drawable.weekview_thisweek));
    }
